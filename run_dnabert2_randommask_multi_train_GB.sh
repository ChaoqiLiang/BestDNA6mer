...
data_path=/mnt/data/oss_beijing/genomic_benchmark_csv
lr=3e-5
...
for data in demo_coding_vs_intergenomic_seqs demo_human_or_worm dummy_mouse_enhancers_ensembl human_enhancers_cohn human_enhancers_ensembl human_ensembl_regulatory human_nontata_promoters human_ocr_ensembl
do
    CUDA_VISIBLE_DEVICES=0,1 torchrun \
        ...
        --data_path  $data_path \
        --kmer 6 \
        --data_train_path ${data}"/train_new.csv" \
        --data_val_path ${data}"/val.csv" \
        --data_test_path ${data}"/test_new.csv" \
        --run_name ${output_name}/${lr}_${data}"_hyenadna_benchmark_seed_42" \
        ...
        --fp16 \
        --save_steps 200 \
        --output_dir ${output_name}/${data}"_hyenadna_benchmark" \
        --seed 42 \
        --save_model True \
