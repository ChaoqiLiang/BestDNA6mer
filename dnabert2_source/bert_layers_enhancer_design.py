...
class BertUnpadSelfAttention(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, cu_seqlens: torch.Tensor,
        ...
        if self.p_dropout or flash_attn_qkvpacked_func is None:
            ...
            # print("KKKKKKKKKKKKKKKKKKKKKKKKKK use flash_attn !!")
            if convert_dtype:
...
class BertForMaskedLM(BertPreTrainedModel):
    ...
    def forward(
        ...
        if labels is not None:
            ...
            # print("sequence_output scores: ", sequence_output.shape)
            # print("Prediction scores:  ",prediction_scores.shape)
            # print("labels:  ", labels.shape)
            # print("masked_token_idx:  ", masked_token_idx.shape)
            # print( "labels.flatten()[masked_token_idx]:  ", labels.flatten()[masked_token_idx].shape)
...
class BertForSequenceClassificationAllPromptTokenAvg(BertPreTrainedModel):
    """Bert Model transformer with a sequence classification/regression head.
    ...
    def forward(
        self,
        input_ids_0: Optional[torch.Tensor] = None,
        ...
        # print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!", outputs0[1].shape)
        pooled_output = (outputs0[1] + outputs1[1]) / 2.0
        pooled_output = self.dropout(pooled_output)
        logits = self.classifier(pooled_output)
